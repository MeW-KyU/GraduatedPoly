...
<%
	System.out.println("customer/edit-customer.jsp");
%>
<title>Edit customer - Doan Delivery Online</title>
<style>
.form-control {
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form:form
						action="admin/customer/edit-cus/${customer.customer_Code}.htm"
						...
						<div class="pagination">
							<div class="pagination-container">
								...
								<c:forEach begin="1" end="${rowCount}" varStatus="row">
									<a href="admin/customer/${customer.customer_Code}.htm/?page=${row.index}"
