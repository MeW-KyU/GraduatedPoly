...
<%
	System.out.println("merchandise/index.jsp");
%>
<title>Merchandise - Doan Delivery Online</title>
<!-- ============================================================== -->
								...
								<c:forEach items="${listMerchandise}" var="merchandise">
									<tr>
										...
										<td><a
											...
											href="admin/merchandise/delete-mer/${merchandise.merchandise_Code}/${sessionScope.account.username}.htm"
						...
						<div class="pagination">
							<div class="pagination-container">
								...
								<c:forEach begin="1" end="${rowCount}" varStatus="row">
									<a href="admin/merchandise/?page=${row.index}"
