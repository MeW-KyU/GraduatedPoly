...
<%
	System.out.println("merchandise/edit-merchandise.jsp");
%>
<title>Edit merchandise - Doan Delivery Online</title>
<style>
.form-control {
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form:form
						action="admin/merchandise/edit-mer/${merchandise.merchandise_Code}.htm"
						method="POST" commandName="merchandise"
						class="form-horizontal form-material">
						<div class="row m-b-10">
							<div class="col-sm-12 p-0">
								<div class="form-group">
									<label class="col-md-12">Mã hàng hoá</label>
									<div class="col-md-12">
						...
						<div class="pagination">
							<div class="pagination-container">
								...
								<c:forEach begin="1" end="${rowCount}" varStatus="row">
									<a
										href="admin/merchandise/edit-mer/${merchandise.merchandise_Code}.htm/?page=${row.index}"
